#ifndef HEADER_CURL_CONFIG_WINRT_H
#define HEADER_CURL_CONFIG_WINRT_H
/***************************************************************************
 *                                  _   _ ____  _
 *  Project                     ___| | | |  _ \| |
 *                             / __| | | | |_) | |
...
/* ================================================================ */
/*              Modified config-win32.h file for WinRT              */
/* ================================================================ */
...
#  define WINRT_MIN_TARGET 0x0602
#endif

#if defined(_MSC_VER) && (_MSC_VER >= 1500)
#  define WINRT_DEF_TARGET  0x0602
#endif

#if defined(_MSC_VER) && (_MSC_VER >= 1500)
#  ifndef _WIN32_WINNT
#    define _WIN32_WINNT WINRT_DEF_TARGET
#  endif
#  ifndef WINVER
#    define WINVER WINRT_DEF_TARGET
#  endif
#  if (_WIN32_WINNT < WINRT_MIN_TARGET) || (WINVER < WINRT_MIN_TARGET)
#    error WinRT does not support Windows build targets prior to Windows 8
#  endif
#endif
...
#endif /* HEADER_CURL_CONFIG_WINRT_H */
