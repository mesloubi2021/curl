// D11.JW - Support for Orbis
#ifndef HEADER_CURL_CONFIG_ORBIS_H
#define HEADER_CURL_CONFIG_ORBIS_H
...
#if !defined(ORBIS) && (!defined(__MINGW32__) || defined(LUP_SECURE))
...
#endif /* HEADER_CURL_CONFIG_ORBIS_H */